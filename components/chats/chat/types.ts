...
export const descriptions: Record<DescriptionKey, string> = {
  AU_ABN:
    'Australian Business Number, a unique identifier for businesses in Australia.',
  AU_ACN:
    'Australian Company Number, a unique identifier for companies in Australia.',
  ...
  SG_NRIC_FIN:
    'National Registration Identity Card/Foreign Identification Number in Singapore.',
  ...
  IBAN_CODE:
    'International Bank Account Number, used to identify bank accounts internationally.',
